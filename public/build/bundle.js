...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$4, 22, 0, 417);
    			attr_dev(input0, "name", "username");
    			attr_dev(input0, "minlength", "10");
    			attr_dev(input0, "maxlength", "32");
    			add_location(input0, file$4, 23, 0, 457);
    			attr_dev(label1, "for", "password");
    			add_location(label1, file$4, 24, 0, 534);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "name", "password");
    			add_location(input1, file$4, 25, 0, 574);
    			attr_dev(button0, "class", "login");
    			add_location(button0, file$4, 27, 0, 639);
    			attr_dev(button1, "class", "signup");
    			add_location(button1, file$4, 28, 0, 696);
    		},
    ...
    /* src\chat_message.svelte generated by Svelte v3.38.3 */

    const file$3 = "src\\chat_message.svelte";

    function create_fragment$3(ctx) {
    	let div1;
    	let div0;
    	let p;
    	let t0_value = /*message*/ ctx[0].what + "";
    	let t0;
    	let t1;
    	let time;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			time = element("time");
    			time.textContent = `${/*ts*/ ctx[2].toLocaleDateString()}`;
    			add_location(p, file$3, 13, 8, 264);
    			add_location(time, file$3, 14, 8, 295);
    			attr_dev(div0, "class", "message-text");
    			add_location(div0, file$3, 12, 4, 228);
    			attr_dev(div1, "class", `message ${/*msgClass*/ ctx[1]}`);
    			add_location(div1, file$3, 10, 0, 185);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*message*/ 1 && t0_value !== (t0_value = /*message*/ ctx[0].what + "")) set_data_dev(t0, t0_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Chat_message", slots, []);
    	let { message } = $$props;
    	let { sender } = $$props;
    	const msgClass = message.who === sender ? "sent" : "recieved";
    	const ts = new Date(message.when);
    	const writable_props = ["message", "sender"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Chat_message> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ message, sender, msgClass, ts });
    	...
    	return [message, msgClass, ts, sender];
    }

    class Chat_message extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*message*/ ctx[0] === undefined && !("message" in props)) {
    			console.warn("<Chat_message> was created without expected prop 'message'");
    		}

    		if (/*sender*/ ctx[3] === undefined && !("sender" in props)) {
    			console.warn("<Chat_message> was created without expected prop 'sender'");
    		}
    	}

    	get message() {
    		throw new Error("<Chat_message>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set message(value) {
    		throw new Error("<Chat_message>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$2, 89, 6, 3303);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = text("My sugestion is don't see that");
    			t4 = space();
    			if (if_block) if_block.c();
    			if_block_anchor = empty();
    			attr_dev(div, "class", "dummy");
    			add_location(div, file$2, 72, 8, 2665);
    			add_location(main, file$2, 68, 6, 2491);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Type a message...");
    			attr_dev(input, "maxlength", "100");
    			add_location(input, file$2, 75, 8, 2789);
    			attr_dev(button, "type", "submit");
    			button.disabled = button_disabled_value = !/*newMessage*/ ctx[0];
    			add_location(button, file$2, 76, 8, 2892);
    			add_location(form, file$2, 74, 6, 2734);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 80, 8, 3064);
    			attr_dev(div, "class", "scroll-button");
    			add_location(div, file$2, 79, 6, 3027);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t = text("You Don't have time for that");
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 66, 2, 2439);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h3 = element("h3");
    			h3.textContent = "Gun.js Group Chatting";
    			add_location(h3, file$1, 20, 8, 440);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong, file$1, 13, 20, 279);
    			add_location(span, file$1, 13, 8, 267);
    			attr_dev(div, "class", "user-bio");
    			add_location(div, file$1, 11, 6, 225);
    			attr_dev(button, "class", "signout-button");
    			add_location(button, file$1, 16, 6, 340);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			h1.textContent = "Secret chats is there";
    			t1 = space();
    			if_block.c();
    			add_location(h1, file$1, 9, 2, 166);
    			add_location(header, file$1, 8, 2, 154);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
